...
{
    public class UpdateUserLatLongController : ApiController
    {
        ...
        public IHttpActionResult Post(int UserId, string Latitude, string Longitude)
        {
            ...
            var obj = objmaster.UpdateUserLatLong(UserId, Latitude, Longitude);
