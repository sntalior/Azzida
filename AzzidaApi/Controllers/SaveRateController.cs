...
{
    public class SaveRateController : ApiController
    {
        ...
        public IHttpActionResult Post(int UserId, int JobId, decimal Rate, int SeekerId)
        {
            string retVal = string.Empty;
            MasterUpdate objmaster = new MasterUpdate();


            var obj = objmaster.RatePost(UserId, JobId, Rate, SeekerId);
            if (obj != null)
            {
                try
                {
