...
{
    public class PayoutToConnectedAccountController : ApiController
    {
        ...
        public IHttpActionResult Get(decimal amount, string accountnumber, int UserId)
        {
            string retVal = string.Empty;
            MasterUpdate objmaster = new MasterUpdate();


            var str= objmaster.PayoutToConnectedAccount(amount, accountnumber, UserId);
            ...
            {
                retVal = ResponseErr.Replace("error occurred", str);
            }
