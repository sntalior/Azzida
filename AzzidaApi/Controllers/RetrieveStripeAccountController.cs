...
{
    public class RetrieveStripeAccountController : ApiController
    {
        ...
        public IHttpActionResult Get(string code, int userid, string accountnumber)
        {
            string retVal = string.Empty;
            MasterUpdate objmaster = new MasterUpdate();

          
            var obj = objmaster.RetrieveStripeAccount(code, userid, accountnumber);
