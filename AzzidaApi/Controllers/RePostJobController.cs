...
{
    public class RePostJobController : ApiController
    {
        ...
        public IHttpActionResult Post(int JobId, int UserId, string FromDate)
        {
            ...
            objmaster.RepostJob(JobId, UserId, FromDate);
            //if (obj != null)
            //{
            try
            {
