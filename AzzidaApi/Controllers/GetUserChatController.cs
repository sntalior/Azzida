...
{
    public class GetUserChatController : ApiController
    {
        ...
        public IHttpActionResult Get(int FromId, int ToId, int JobId)
        {
            ...
            var obj = objmaster.GetUserChats(FromId, ToId, JobId);
