...
{
    public class JobCompleteController : ApiController
    {
        ...
        public IHttpActionResult Post(int Id, string CompleteDate, string IsComplete)
        {
            ...
            var obj = objmaster.JobComplete(Id, CompleteDate, IsComplete);
            if (obj != null)
            {
                try
                {
